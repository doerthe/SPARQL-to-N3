...
//            RDFParser.create().source(data).lang(Lang.NTRIPLES).parse(model);
        ...
        try (FileWriter myWriter = new FileWriter("src/main/resources/SPARQL_Benchmarks/Vadalog Translation of Benchmark Datasets/" + schemaName + ".txt");) {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            rdt.translateRDFData("src/main/resources/SPARQL_Benchmarks/BeSeppi/dataset/BeSEPPIgraph.nt", "beseppi", "default");

            // Translate the SWDF dataset
            rdt.translateRDFData("src/main/resources/SPARQL_Benchmarks/Feasible/dataset/preprocessed_UTF8_dataset.nt", "swdfmygraph", "<http://localhost:3030/VADALOG/data/MyGraph>");
            rdt.translateRDFData("src/main/resources/SPARQL_Benchmarks/Feasible/dataset/preprocessed_UTF8_dataset.nt", "swdfmygraph", "default");


            // Translate the P2Bench dataset
            rdt.translateRDFData("src/main/resources/SPARQL_Benchmarks/SP2bench/generator/bin/dataset/50k_dataset.n3", "sp2bench50k", "default");
//            rdt.translateRDFData("src/main/resources/SPARQL_Benchmarks/SP2bench/generator/bin/dataset/50k_dataset.n3", "prop_path_sp2bench", "default");
            rdt.translateRDFData("src/main/resources/SPARQL_Benchmarks/SP2bench/generator/bin/dataset/50k_ontology_dataset.n3", "ontology_sp2bench", "default");
