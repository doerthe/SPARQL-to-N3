...
/**
 * Steps taken to get projects to work: remove superfluous projects (osgi,
 * fuseki, etc.) select all projects -> maven -> update project (yes) remove
 * some junit "test" scopes in pom (also used in main code) remove jena-tdb2
 * tests (_cannot_ resolve jena-core, arq) add commons lang3 dep for
 * jena-text-es re-create gMark, yagoFacts TDB datasets
 */
