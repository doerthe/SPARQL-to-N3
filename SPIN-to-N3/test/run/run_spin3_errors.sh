...
if [[ $recursion == "true" ]]; then
    ...
    eye ../../auxiliary-files/runtime.n3 $n3_file --turtle $nt_file --pass-only-new --nope > $result_file
else
    # not including query as data (before):
    eye ../../auxiliary-files/runtime.n3 --turtle $nt_file --query $n3_file --nope > $result_file
fi
